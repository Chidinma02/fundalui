      ...
      <div class="row mt-2">
        <div class="col-12 col-lg-6">
          ...
          <div class="">
            ...
            <div class="mt-2 logo text-center">
              <h1 class="mt-5 wel ht">Welcome back!</h1>
              <h1 class="ht">We miss you</h1>
            </div>
        ...
        <div class="col-12 col-lg-6 mt-3 boxshadowing">
          ...
          <form class="row g-3 mt-3 fo" @submit.prevent="onLogin()">
            ...
            <div class="col-md-12">
              ...
              <input
                type="password"
                class="form-control my-input shadow-none"
                id="inputPassword4"
          ...
          <div class="mt-3">
            <p class="we">
              Already have an account?<span class="wel" @click="gotosign"
                >Register Here</span
              >
            </p>
            <p class="last">
